...
${OBJECTDIR}/src/jfprint_Core.o: src/jfprint_Core.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_Core.o src/jfprint_Core.cpp

${OBJECTDIR}/src/jfprint_Device.o: src/jfprint_Device.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_Device.o src/jfprint_Device.cpp

${OBJECTDIR}/src/jfprint_DiscoveredDevice.o: src/jfprint_DiscoveredDevice.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_DiscoveredDevice.o src/jfprint_DiscoveredDevice.cpp

${OBJECTDIR}/src/jfprint_DiscoveredDeviceList.o: src/jfprint_DiscoveredDeviceList.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_DiscoveredDeviceList.o src/jfprint_DiscoveredDeviceList.cpp

${OBJECTDIR}/src/jfprint_DiscoveredPrint.o: src/jfprint_DiscoveredPrint.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_DiscoveredPrint.o src/jfprint_DiscoveredPrint.cpp

${OBJECTDIR}/src/jfprint_DiscoveredPrintList.o: src/jfprint_DiscoveredPrintList.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_DiscoveredPrintList.o src/jfprint_DiscoveredPrintList.cpp

${OBJECTDIR}/src/jfprint_Driver.o: src/jfprint_Driver.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_Driver.o src/jfprint_Driver.cpp

${OBJECTDIR}/src/jfprint_Img.o: src/jfprint_Img.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_Img.o src/jfprint_Img.cpp

${OBJECTDIR}/src/jfprint_PrintData.o: src/jfprint_PrintData.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/jfprint_PrintData.o src/jfprint_PrintData.cpp

${OBJECTDIR}/src/util.o: src/util.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/java-8-oracle/include -I/usr/lib/jvm/java-8-oracle/include/linux -I/usr/local/libfprint/include -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/util.o src/util.cpp
